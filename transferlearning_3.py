...
def main(approach):
    ...
    optimal_model.save_weights("Weights/setting_3_1")   
    ...
    init_model.load_weights("Weights/setting_3_1")
    ...
    model.save_weights("Weights/setting_3_2")
    ...
    results_file = "Results/setting_3_c"
    ...
    if transfer_learning == True:
        ...
        init_model.load_weights("Weights/setting_3_2")
    ...
    results_file = "Results/setting_3_surv"
